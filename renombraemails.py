...
if __name__ == "__main__":
    ...
    for archivo in archivos:
        # Si el archivo comienza por YYYYMMDD lo ignoro
        if archivo[:8].isdigit():
        ...
        # Renombro el archivo con el formato YYYYMMDD_nombreoriginal.ext
        nuevo_nombre = f"{fecha.strftime('%Y%m%d')} {archivo}"
